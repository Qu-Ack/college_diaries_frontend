  ...
  if (typeof localStorage.token != "undefined") {
    ...
    if (user.master == "true") {
      return (
        <ul className="nav-links">
          <li className="blogs-nav">
            <Link className="link-blogs-nav" to="blogs">
              blogs
            </Link>
          </li>
          <li className="blog-create-nav">
            <Link className="link-blog-create-nav" to="write">
              write
            </Link>
          </li>
        </ul>
    ...
    return (
      <ul className="nav-links">
        ...
        <li className="whoami-nav">
          {" "}
          <Link className="link-whoami-nav" to="whoami">
            whoami
          </Link>
        </li>
      </ul>
